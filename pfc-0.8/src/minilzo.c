...
#endif
#if !defined(__LZO_HAVE_PTR_T)
#  if defined(SIZEOF_CHARP) && defined(SIZEOF_UNSIGNED_LONG)
#    if (SIZEOF_CHARP == SIZEOF_UNSIGNED_LONG)
...
#endif
#if !defined(__LZO_HAVE_PTR_T)
#  if defined(SIZEOF_CHARP) && defined(SIZEOF_UNSIGNED)
#    if (SIZEOF_CHARP == SIZEOF_UNSIGNED)
...
#endif
#if !defined(__LZO_HAVE_PTR_T)
#  if defined(SIZEOF_CHARP) && defined(SIZEOF_UNSIGNED_SHORT)
#    if (SIZEOF_CHARP == SIZEOF_UNSIGNED_SHORT)
...
#endif
#if !defined(__LZO_HAVE_PTR_T)
#  if defined(LZO_HAVE_CONFIG_H) || defined(SIZEOF_CHARP)
...
static lzo_bool basic_ptr_check(void)
{
    ...
    r &= __lzo_assert(SIZEOF_CHARP == sizeof(char *));
#endif
